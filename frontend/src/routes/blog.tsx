      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <header className="mb-12">
          ...
          <p className="mt-2 text-neutral-400">
            Updates and notes from the Cryptly team.
          </p>
        </header>
        ...
        {admin && (
          <section className="mb-14 rounded-xl border border-neutral-800 bg-neutral-950/80 p-6 shadow-xl">
            ...
            <Tabs defaultValue="write" className="w-full">
              ...
              <TabsContent value="preview" className="mt-0 min-h-[320px] rounded-lg border border-neutral-800 bg-black/40 p-4">
                {body.trim() ? (
            ...
            <ul className="space-y-4">
              {posts.map((p) => (
                <li key={p.id}>
                  ...
                  >
                    <span className="text-lg font-medium text-neutral-100 group-hover:underline">
                      {p.title}
                    </span>
