 ...
 * The full-fat landing page. Zero-knowledge explained with live mocks.
 * Self-contained: every helper, section, and utility inlined here.
 * ──────────────────────────────────────────────────────────────────────────── */
...
function fakeCiphertext(seed: string, length = 88): string {
  const alphabet =
...
// ── Cryptly-on-Cryptly security section ─────────────────────────────────────
function CryptlyOnCryptlySection() {
  const dump = useMemo(
