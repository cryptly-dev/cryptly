// Generated by kea-typegen on Sun, 26 Apr 2026 17:11:28 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface invitationsLogicType extends Logic {
    actionCreators: {
        ...
        setLastCreatedInvitation: (invitation: Invitation | null) => ({
            type: "set last created invitation (src.lib.logics.invitationsLogic)";
            payload: {
    ...
    actionKeys: {
        ...
        "set last created invitation (src.lib.logics.invitationsLogic)": "setLastCreatedInvitation";
    ...
    actionTypes: {
        ...
        setLastCreatedInvitation: "set last created invitation (src.lib.logics.invitationsLogic)";
    ...
    actions: {
        ...
        setLastCreatedInvitation: (invitation: Invitation | null) => void;
    ...
    asyncActions: {
        ...
        setLastCreatedInvitation: (invitation: Invitation | null) => Promise<any>;
    ...
    reducers: {
        ...
        lastCreatedInvitation: (state: Invitation | null, action: any, fullState: any) => Invitation | null;
    ...
    selectors: {
        ...
        lastCreatedInvitation: (state: any, props?: any) => Invitation | null;
