// Generated by kea-typegen on Sat, 25 Apr 2026 07:36:33 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface deviceFlowRequesterLogicType extends Logic {
    actionCreators: {
        unlock: (passphrase: string) => ({
            type: "unlock (src.lib.logics.deviceFlowRequesterLogic)";
            payload: {
                passphrase: string;
            };
        });
    ...
    actionKeys: {
        "unlock (src.lib.logics.deviceFlowRequesterLogic)": "unlock";
    ...
    actionTypes: {
        unlock: "unlock (src.lib.logics.deviceFlowRequesterLogic)";
