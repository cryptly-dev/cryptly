// Generated by kea-typegen on Mon, 20 Apr 2026 09:28:13 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface projectLogicType extends Logic {
    actionCreators: {
        ...
        pushToIntegrations: () => ({
            type: "push to integrations (src.lib.logics.projectLogic)";
            payload: {
                value: true;
            };
        });
        setIsPushing: (isPushing: boolean) => ({
            type: "set is pushing (src.lib.logics.projectLogic)";
            payload: {
                isPushing: boolean;
            };
        });
    ...
    actionKeys: {
        ...
        "push to integrations (src.lib.logics.projectLogic)": "pushToIntegrations";
        "set is pushing (src.lib.logics.projectLogic)": "setIsPushing";
    ...
    actionTypes: {
        ...
        pushToIntegrations: "push to integrations (src.lib.logics.projectLogic)";
        setIsPushing: "set is pushing (src.lib.logics.projectLogic)";
    ...
    actions: {
        ...
        setSyncConnection: (connection: EventSourceWrapper | null) => void;
    ...
    asyncActions: {
        ...
        pushToIntegrations: () => Promise<any>;
        setIsPushing: (isPushing: boolean) => Promise<any>;
        ...
        setSyncConnection: (connection: EventSourceWrapper | null) => Promise<any>;
    ...
    defaults: {
        isExternallyUpdated: boolean;
        isPushing: boolean;
        syncConnection: EventSourceWrapper | null;
    ...
    reducers: {
        ...
        isPushing: (state: boolean, action: any, fullState: any) => boolean;
        syncConnection: (state: EventSourceWrapper | null, action: any, fullState: any) => EventSourceWrapper | null;
    ...
    selectors: {
        ...
        isPushing: (state: any, props?: any) => boolean;
        syncConnection: (state: any, props?: any) => EventSourceWrapper | null;
        ...
        secretsSyncedWithGithub: (state: any, props?: any) => boolean;
    ...
    values: {
        ...
        secretsSyncedWithGithub: boolean;
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        secretsSyncedWithGithub: (projectData: DecryptedProject | null) => boolean;
