// Generated by kea-typegen on Tue, 14 Oct 2025 20:08:00 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface personalInvitationsLogicType extends Logic {
    actionCreators: {
        createPersonalInvitation: (invitedUserId: string, invitedUserPublicKey: string, role: ProjectMemberRole) => ({
    ...
    actions: {
        createPersonalInvitation: (invitedUserId: string, invitedUserPublicKey: string, role: ProjectMemberRole) => void;
    ...
    asyncActions: {
        createPersonalInvitation: (invitedUserId: string, invitedUserPublicKey: string, role: ProjectMemberRole) => Promise<any>;
