// Generated by kea-typegen on Thu, 16 Apr 2026 08:38:08 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface authLogicType extends Logic {
    actionCreators: {
        ...
        setRefreshToken: (refreshToken: string) => ({
            type: "set refresh token (src.lib.logics.authLogic)";
            payload: {
                refreshToken: string;
            };
        });
        setTokens: (jwtToken: string, refreshToken: string) => ({
            type: "set tokens (src.lib.logics.authLogic)";
            payload: {
                jwtToken: string;
                refreshToken: string;
            };
        ...
        loginLocal: (email: string) => ({
            type: "login local (src.lib.logics.authLogic)";
            payload: string;
        });
        loginLocalSuccess: (jwtToken: string | null, payload?: string) => ({
            type: "login local success (src.lib.logics.authLogic)";
            payload: {
                jwtToken: string | null;
                payload?: string;
            };
        });
        loginLocalFailure: (error: string, errorObject?: any) => ({
            type: "login local failure (src.lib.logics.authLogic)";
            payload: {
                error: string;
                errorObject?: any;
            };
    ...
    actionKeys: {
        ...
        "set refresh token (src.lib.logics.authLogic)": "setRefreshToken";
        "set tokens (src.lib.logics.authLogic)": "setTokens";
        ...
        "login local (src.lib.logics.authLogic)": "loginLocal";
        "login local success (src.lib.logics.authLogic)": "loginLocalSuccess";
        "login local failure (src.lib.logics.authLogic)": "loginLocalFailure";
    ...
    actionTypes: {
        ...
        setRefreshToken: "set refresh token (src.lib.logics.authLogic)";
        setTokens: "set tokens (src.lib.logics.authLogic)";
        ...
        loginLocal: "login local (src.lib.logics.authLogic)";
        loginLocalSuccess: "login local success (src.lib.logics.authLogic)";
        loginLocalFailure: "login local failure (src.lib.logics.authLogic)";
    ...
    actions: {
        ...
        loginLocalSuccess: (jwtToken: string | null, payload?: string) => void;
        loginLocalFailure: (error: string, errorObject?: any) => void;
        loadUserData: () => void;
    ...
    asyncActions: {
        ...
        setTokens: (jwtToken: string, refreshToken: string) => Promise<any>;
        ...
        loginLocal: (email: string) => Promise<any>;
        loginLocalSuccess: (jwtToken: string | null, payload?: string) => Promise<any>;
        loginLocalFailure: (error: string, errorObject?: any) => Promise<any>;
    ...
    reducers: {
        ...
        refreshToken: (state: string | null, action: any, fullState: any) => string | null;
    ...
    selectors: {
        ...
        refreshToken: (state: any, props?: any) => string | null;
