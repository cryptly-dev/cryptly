...
- `cm`: commit and push **only** changes in files you made to the current branch, using the `gh` CLI for the push flow where relevant. Do not include unrelated user changes.
